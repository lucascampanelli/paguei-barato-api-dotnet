...
namespace PagueiBaratoApi.Infrastructure.Migrations
{
    ...
    [Migration("20260821063156_AdicionaCaminhoImagem")]
    partial class AdicionaCaminhoImagem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PagueiBaratoApi.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PagueiBaratoApi.Domain.Entities.RefreshToken", b =>
                {
                    b.HasOne("PagueiBaratoApi.Domain.Entities.Usuario", "Usuario")
                        .WithOne("RefreshToken")
                        .HasForeignKey("PagueiBaratoApi.Domain.Entities.RefreshToken", "UsuarioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
